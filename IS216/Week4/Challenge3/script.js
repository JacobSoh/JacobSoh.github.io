...
function show(button_element) {
    ...
    */
    ...
    const text_content = document.getElementById("ta-fun-fact");
    const img_content = document.getElementById("ta-photo");
    ...
    const username = button_element.getAttribute("id");
    ...
    text_content.innerText = facts[username];
    ...
    img_content.setAttribute("src", "photos/" + username);
    ...
    if (previous_ta) {
        document.getElementById(previous_ta).classList.remove("alter");
    };
    previous_ta = username;

    button_element.classList.add("alter");
